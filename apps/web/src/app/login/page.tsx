...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        if (!email || !password) {
            setLocalError(copy.login.validationRequired);
            return;
        }
                    ...
                    >
                        ...
                        <div>
                            ...
                            <div className="text-center mb-8">
                                ...
                                <h2 className="text-3xl font-bold text-white">{copy.login.title}</h2>
                                <p className="text-gray-400 mt-2">{copy.login.subtitle}</p>
                            </div>
